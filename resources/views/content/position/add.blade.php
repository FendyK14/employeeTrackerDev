        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="font-weight-bold mb-0">Add Position</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="pt-3" method="POST" enctype="multipart/form-data"
                            action="{{ route('Added Position') }}">
                            @csrf
                            <div class="row mb-3 align-items-center">
                                <label for="exampleInputName1" class="col-form-label col-sm-2">Position Name</label>
                                <div class="col-sm-10">
                                    <input type="text" name="positionName" class="form-control" id="exampleInputName1"
