        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="font-weight-bold mb-0">Add Employee</h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form class="pt-3" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="col-sm-10">
                                    <select name="positionId" class="form-control" id="exampleInputPosition1" required>
                                        ...
                                        @foreach ($positions as $data)
                                            <option value="{{ $data->positionId }}">{{ $data->positionName }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" name="employeeAddress" class="form-control" id="exampleInputAddress1" required></textarea>
                                </div>
                            </div>
                            <div class="mt-3">
                                ...
                                <div class="mt-3 d-flex justify-content-center">
                                    <button type="button"
                                        class="btn btn-block btn-outline-secondary fw-bold auth-form-btn"> <a
                                            class="text-decoration-none" href={{ route('List Employee') }}>Back</a></button>
                                </div>
                            </div>
                        </form>
                    </div>
